...
let currentPass = null; // kept in memory only
let lastData = null;
...
function renderMember(data, member){
  ...
  memberGroup.textContent = groupLabel(groups, member.groupId);
  ...
  updatedAtEl.textContent = data.updatedAt ? `Updated: ${data.updatedAt}` : "";
...
loginBtn.addEventListener("click", async ()=>{
  ...
  try{
    ...
    loginMsg.textContent = "حدث خطأ في تحميل البيانات.";
  }finally{
